...
private val DarkColorScheme =
  darkColorScheme(
    ...
    surfaceVariant = SophisticatedSurfaceSec,
    onSurfaceVariant = SophisticatedOnTertiary
  )

private val LightColorScheme = DarkColorScheme // Forced beautiful dark mode to reduce fatigue as requested!
